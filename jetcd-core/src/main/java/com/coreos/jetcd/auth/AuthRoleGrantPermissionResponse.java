...
/**
 * AuthRoleGrantPermissionResponse returned by {@link com.coreos.jetcd.Auth#roleGrantPermission(ByteSequence, ByteSequence, ByteSequence, Permission.Type)} contains a header.
 */
