...
/**
 * Protobuf type {@code jetcd.TxnResponse}
 */
public  final class TxnResponse extends
    com.google.protobuf.GeneratedMessage implements
    // @@protoc_insertion_point(message_implements:jetcd.TxnResponse)
        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000004) == 0x00000004)) {
              responses_ = new java.util.ArrayList<com.coreos.jetcd.ResponseOp>();
              mutable_bitField0_ |= 0x00000004;
            }
            responses_.add(input.readMessage(com.coreos.jetcd.ResponseOp.parser(), extensionRegistry));
            break;
          }
        }
      }
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.coreos.jetcd.EtcdJavaProto.internal_static_jetcd_TxnResponse_descriptor;
  }

  protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.coreos.jetcd.EtcdJavaProto.internal_static_jetcd_TxnResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.coreos.jetcd.TxnResponse.class, com.coreos.jetcd.TxnResponse.Builder.class);
  }
  ...
  private java.util.List<com.coreos.jetcd.ResponseOp> responses_;
  /**
   ...
   * </pre>
   */
  public java.util.List<com.coreos.jetcd.ResponseOp> getResponsesList() {
    return responses_;
  }
  /**
   * <code>repeated .jetcd.ResponseOp responses = 3;</code>
   ...
   * </pre>
   */
  public java.util.List<? extends com.coreos.jetcd.ResponseOpOrBuilder> 
   ...
   * </pre>
   */
  public com.coreos.jetcd.ResponseOp getResponses(int index) {
   ...
   * </pre>
   */
  public com.coreos.jetcd.ResponseOpOrBuilder getResponsesOrBuilder(
      int index) {
    return responses_.get(index);
  }
  ...
  public static com.coreos.jetcd.TxnResponse parseFrom(
  ...
  public static com.coreos.jetcd.TxnResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.coreos.jetcd.TxnResponse parseFrom(
  ...
  public static com.coreos.jetcd.TxnResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.coreos.jetcd.TxnResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return PARSER.parseDelimitedFrom(input);
  }
  public static com.coreos.jetcd.TxnResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(com.coreos.jetcd.TxnResponse prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:jetcd.TxnResponse)
      com.coreos.jetcd.TxnResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.coreos.jetcd.EtcdJavaProto.internal_static_jetcd_TxnResponse_descriptor;
    }
    ...
    // Construct using com.coreos.jetcd.TxnResponse.newBuilder()
    private Builder() {
    ...
    public com.coreos.jetcd.TxnResponse getDefaultInstanceForType() {
      return com.coreos.jetcd.TxnResponse.getDefaultInstance();
    }

    public com.coreos.jetcd.TxnResponse build() {
      com.coreos.jetcd.TxnResponse result = buildPartial();
    ...
    public com.coreos.jetcd.TxnResponse buildPartial() {
      com.coreos.jetcd.TxnResponse result = new com.coreos.jetcd.TxnResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.coreos.jetcd.TxnResponse) {
        return mergeFrom((com.coreos.jetcd.TxnResponse)other);
      } else {
    ...
    public Builder mergeFrom(com.coreos.jetcd.TxnResponse other) {
      if (other == com.coreos.jetcd.TxnResponse.getDefaultInstance()) return this;
      if (other.hasHeader()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.coreos.jetcd.TxnResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.coreos.jetcd.TxnResponse) e.getUnfinishedMessage();
        throw e;
      } finally {
    ...
    private void ensureResponsesIsMutable() {
      if (!((bitField0_ & 0x00000004) == 0x00000004)) {
        responses_ = new java.util.ArrayList<com.coreos.jetcd.ResponseOp>(responses_);
        bitField0_ |= 0x00000004;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilder<
        com.coreos.jetcd.ResponseOp, com.coreos.jetcd.ResponseOp.Builder, com.coreos.jetcd.ResponseOpOrBuilder> responsesBuilder_;
    ...
    public Builder setResponses(
        int index, com.coreos.jetcd.ResponseOp value) {
      if (responsesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setResponses(
        int index, com.coreos.jetcd.ResponseOp.Builder builderForValue) {
      if (responsesBuilder_ == null) {
        ensureResponsesIsMutable();
     ...
     * </pre>
     */
    public Builder addResponses(com.coreos.jetcd.ResponseOp value) {
      if (responsesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addResponses(
        com.coreos.jetcd.ResponseOp.Builder builderForValue) {
      if (responsesBuilder_ == null) {
        ensureResponsesIsMutable();
    ...
    public Builder addAllResponses(
        java.lang.Iterable<? extends com.coreos.jetcd.ResponseOp> values) {
      if (responsesBuilder_ == null) {
        ensureResponsesIsMutable();
     ...
     * </pre>
     */
    public com.coreos.jetcd.ResponseOp.Builder getResponsesBuilder(
        int index) {
     ...
     * </pre>
     */
    public com.coreos.jetcd.ResponseOp.Builder addResponsesBuilder() {
      return getResponsesFieldBuilder().addBuilder(
          com.coreos.jetcd.ResponseOp.getDefaultInstance());
    }
    /**
     * <code>repeated .jetcd.ResponseOp responses = 3;</code>
     *
    ...
    public com.coreos.jetcd.ResponseOp.Builder addResponsesBuilder(
        int index) {
      return getResponsesFieldBuilder().addBuilder(
          index, com.coreos.jetcd.ResponseOp.getDefaultInstance());
    }
    /**
     * <code>repeated .jetcd.ResponseOp responses = 3;</code>
     *
     ...
     * </pre>
     */
    public java.util.List<com.coreos.jetcd.ResponseOp.Builder> 
         getResponsesBuilderList() {
      return getResponsesFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilder<
        com.coreos.jetcd.ResponseOp, com.coreos.jetcd.ResponseOp.Builder, com.coreos.jetcd.ResponseOpOrBuilder> 
        getResponsesFieldBuilder() {
      if (responsesBuilder_ == null) {
    ...
    // @@protoc_insertion_point(builder_scope:jetcd.TxnResponse)
  }

  // @@protoc_insertion_point(class_scope:jetcd.TxnResponse)
  private static final com.coreos.jetcd.TxnResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.coreos.jetcd.TxnResponse();
  }

  public static com.coreos.jetcd.TxnResponse getDefaultInstance() {
