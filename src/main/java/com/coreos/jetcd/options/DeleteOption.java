...
public class DeleteOption {
    ...
    public static class Builder {
         ...
         * delete request will delete the keys from <i>key</i> to <i>endKey</i> (exclusive).
         * <p>If end key is '\0', the range is all keys >= key.
         * <p>If the end key is one bit larger than the given key, then it deletes all keys with the prefix (the given key).
