...
public class ClientServiceTest {
  ...
  public Option[] config() {
    final MavenArtifactUrlReference karafUrl = maven()
        ...
        .version(System.getProperty("version.karaf"))
        .type("tar.gz");
    ...
    return new Option[] {
        ...
        karafDistributionConfiguration()
            ...
            .name("Apache Karaf")
            .unpackDirectory(new File(System.getProperty("build.dir"), "exam"))
        ...
        mavenBundle()
            .groupId("com.coreos")
            .artifactId("jetcd-all")
            .version(System.getProperty("version.jetcd"))
            .start(),
        mavenBundle()
            .groupId("com.coreos")
            .artifactId("jetcd-osgi")
            .version(System.getProperty("version.jetcd"))
            .start(),
        mavenBundle()
            .groupId("org.assertj")
            .artifactId("assertj-core")
            .version(System.getProperty("version.assertj"))
            .start(),
